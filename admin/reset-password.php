...
<html>
   <head>
        ...
        <title>Bluelinkns | Reset Password</title>
                        ...
                        <?php
                            if(isset($_POST['sendotp'])) {
                                ...
                                if(mysqli_num_rows($result) == 0) {
                                    echo "<div class='alert alert-danger'>No account on this e-mail.</div>";
                                    unset($_POST['sendotp']);
                                } else {
                        ...
                        <?php
                            ...
                            if(isset($_POST['verifyotp'])) {
                                ...
                                if($_POST['otp'] == $row['OTP']) {
                                    ...
                                    $mysql_query = "DELETE FROM otpsdata WHERE Id = {$_POST['otpid']};";
                                    mysqli_query($conn, $mysql_query);
                                    header("Location: {$hostname}/admin/reset-password-2.php");
                                } else {
